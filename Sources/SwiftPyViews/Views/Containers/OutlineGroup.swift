...
//            let iter = try py.retain(py.iter(list))
//            
//            while let node = try? py.next(iter.reference) {
...
//                let action = PyObject(model[.action])
//                try? action?(newValue)
//            }
//        }
//    }
...
//    
//    var body: some View {
//        py.main.sidebar?.reference.anyView
//    }
//}
//
//#Preview {
